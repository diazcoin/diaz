...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    addrman.Add(CAddress(addr2, NODE_NONE), ResolveService("250.3.1.1", 48338));
    addrman.Add(CAddress(addr3, NODE_NONE), ResolveService("250.3.1.1", 48338));
    addrman.Add(CAddress(addr4, NODE_NONE), ResolveService("250.4.1.1", 48338));
    ...
    addrman.Add(CAddress(addr5, NODE_NONE), ResolveService("250.3.1.1", 48338));
    addrman.Good(CAddress(addr5, NODE_NONE));
    addrman.Add(CAddress(addr6, NODE_NONE), ResolveService("250.3.1.1", 48338));
    addrman.Good(CAddress(addr6, NODE_NONE));
    addrman.Add(CAddress(addr7, NODE_NONE), ResolveService("250.1.1.3", 48338));
