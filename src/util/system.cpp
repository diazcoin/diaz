 ...
 * https://github.com/diaz/diaz/pull/16097#issuecomment-514627823
 */
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Diazcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Diazcoin";
#else
    // Unix
    return pathRet / ".diaz";
#endif
