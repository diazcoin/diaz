...
#ifndef DIAZ_UTIL_SETTINGS_H
#define DIAZ_UTIL_SETTINGS_H
...
//!       https://github.com/diaz/diaz/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored diaz settings. This struct combines settings from the command line
