...
#include <config/diaz-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDiazURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DiazUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDiazURI(info));
}
