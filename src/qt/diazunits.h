...
#ifndef DIAZ_QT_DIAZUNITS_H
#define DIAZ_QT_DIAZUNITS_H
...
/** Diaz unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DiazUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DiazUnits(QObject *parent);

    /** Diaz units.
      @note Source: https://en.diaz.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DIAZ,
...
typedef DiazUnits::Unit DiazUnit;

#endif // DIAZ_QT_DIAZUNITS_H
