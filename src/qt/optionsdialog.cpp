    ...
    mapper(nullptr)
{
    ...
    ui->diazAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->diazAtStartup);
    ...
    ui->diazAtStartup->setToolTip(ui->diazAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->diazAtStartup->setText(ui->diazAtStartup->text().arg(PACKAGE_NAME));

    ui->openDiazConfButton->setToolTip(ui->openDiazConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DiazUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->diazAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDiazConfButton_clicked()
{
