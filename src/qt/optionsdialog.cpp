    ...
    mapper(0)
{
    ...
    ui->diazAtStartup->setToolTip(ui->diazAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->diazAtStartup->setText(ui->diazAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDiazConfButton->setToolTip(ui->openDiazConfButton->toolTip().arg(tr(PACKAGE_NAME)));
