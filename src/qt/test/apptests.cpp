...
//! Entry point for DiazApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DiazApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DiazGUI tests.
void AppTests::guiTests(DiazGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DiazGUI::consoleShown, this, &AppTests::consoleTests);
