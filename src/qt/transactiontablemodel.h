...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, DiazUnits::SeparatorStyle separators=DiazUnits::separatorStandard) const;
...
#endif // DIAZ_QT_TRANSACTIONTABLEMODEL_H
