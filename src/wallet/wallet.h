...
#ifndef DIAZ_WALLET_WALLET_H
#define DIAZ_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! diaz from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The diaz Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this diaz node, and set to 0 for transactions that were created
