...
#ifndef DIAZ_CRYPTO_CHACHA_POLY_AEAD_H
#define DIAZ_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@diaz.
 *
 ...
 *
 * The chacha20-poly1305@diaz combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@diaz cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@diaz are relatively fast in
...
#endif // DIAZ_CRYPTO_CHACHA_POLY_AEAD_H
