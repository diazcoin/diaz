...
class BIP66Test(DiazTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # diazd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and diazd produces more specific reject
            # reasons.
