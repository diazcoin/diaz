...
# TestP2PConn: A peer we use to send messages to diazd, and store responses.
...
class CompactBlocksTest(DiazTestFramework):
    ...
    # This test actually causes diazd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that diazd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for diazd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # diazd will not send blocktxn responses for blocks whose height is
