...
class P2PPermissionsTests(DiazTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].diazconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].diazconf, 'w', encoding="utf8") as f:
            f.write(newText)
