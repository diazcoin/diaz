...
class TestShell:
    """Wrapper Class for DiazTestFramework.

    The TestShell class extends the DiazTestFramework
    ...
    class __TestShell(DiazTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DiazTestFramework child class.
            self.num_nodes = 1
