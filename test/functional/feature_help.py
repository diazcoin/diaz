...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start diaz with -h for help text")
        ...
        self.log.info("Start diaz with -version for version information")
        ...
        self.log.info("Start diazd with -fakearg to make sure it does not start")
