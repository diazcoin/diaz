...
(define* (make-diaz-cross-toolchain target
                                  #:key
...
desirable for building diaz Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-diaz-cross-toolchain "i686-linux-gnu")
       (make-diaz-cross-toolchain "x86_64-linux-gnu")
       (make-diaz-cross-toolchain "aarch64-linux-gnu")
       (make-diaz-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-diaz-cross-toolchain "riscv64-linux-gnu"
