# Bootstrappable Diaz Core Builds

This directory contains the files necessary to perform bootstrappable Diaz
Core builds.
...
- 24GB of free disk space on the partition that the Diaz Core git repository
  resides in
...
For a Diaz Core depends development environment, simply invoke
...
From the top of a clean Diaz Core repository:
...
To use dongcarl's substitute server for Diaz Core builds after having
