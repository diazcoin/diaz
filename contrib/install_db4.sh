...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the diaz repository."
  exit 1
fi
...
# See https://github.com/diaz/diaz/issues/16064
...
echo 'When compiling diazd, run `./configure` in the following way:'
echo
