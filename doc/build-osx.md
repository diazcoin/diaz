...
1. Clone the Diaz Core source code:
    ```shell
...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Diaz Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Diaz"

touch "/Users/${USER}/Library/Application Support/Diaz/diaz.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Diaz/diaz.conf"
```

The first time you run diazd, it will start downloading the blockchain. This process could
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/diaz-core/diaz-detached-sigs).
