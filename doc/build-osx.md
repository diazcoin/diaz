...
## Running
Bitcoin Core is now available at `./src/diazd`

Before running, you may create an empty configuration file:
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Bitcoin"

touch "/Users/${USER}/Library/Application Support/Bitcoin/diaz.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Bitcoin/diaz.conf"
```
...
## Other commands:
```shell
./src/diazd -daemon      # Starts the bitcoin daemon.
