...
diaz.conf        | contains configuration settings for diazd or bitcoin-qt
diazd.pid        | stores the process id of diazd while running
...
debug.log           | contains debug information and general logging generated by diazd or bitcoin-qt
