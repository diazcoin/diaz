...
* On the new release branch in [`configure.ac`](../configure.ac) and [`build_msvc/diaz_config.h`](/build_msvc/diaz_config.h) (see [this commit](https://github.com/bitcoin/bitcoin/commit/742f7dd)):
