Diaz Core version 0.10.4 is now available from:

  <https://diaz.org/bin/diaz-core-0.10.4/>
...
- #6953 `43c2789` Split diaz-tx into its own package
- #6953 `dfe0d4d` Include diaz-tx binary on Debian/Ubuntu
