Diaz Core version 0.9.4 is now available from:

  https://diaz.org/bin/0.9.4/
...
this update is incompatible with the Diaz system and could lead to consensus
forks.

Diaz Core released binaries from https://diaz.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~diaz/+archive/ubuntu/diaz
- A third-party or self-compiled Diaz Core

upgrade to Diaz Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
