Diaz Core version 0.11.1 is now available from:

  <https://diaz.org/bin/diaz-core-0.11.1/>
...
(see https://github.com/diaz/diaz/pull/6795).
...
one was randomly violated by all deployed diaz software prior to
...
Diaz Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Diazj has done so for a similar span of time.
Diazjs and electrum have been more recently updated.
...
[1] On the Malleability of Diaz Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/diaz/paper_9.pdf
...
(see https://github.com/diaz/diaz/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libdiazconsensus: avoid a crash in multi-threaded environments
