Diaz Core version 0.16.1 is now available from:

  <https://diazcore.org/bin/diaz-core-0.16.1/>
...
- #12843 `df38b13` Test starting diazd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure diazd processes are cleaned up when tests end (sdaftuar)
