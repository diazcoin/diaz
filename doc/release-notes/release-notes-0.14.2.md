Diaz Core version 0.14.2 is now available from:

  <https://diaz.org/bin/diaz-core-0.14.2/>
...
(in Diaz Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate diaz-config.h as necessary (theuni)
