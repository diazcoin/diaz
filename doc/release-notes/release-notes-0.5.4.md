Diaz version 0.5.4 is now available for download at:
http://sourceforge.net/projects/diaz/files/Diaz/diaz-0.5.4/
...
http://gitorious.org/diaz/diazd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Diaz-Qt notifications under Growl 1.3.
Increase required age of Diaz-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDiaz properly when installing Diaz-Qt over it. (Windows)
