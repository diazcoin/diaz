Diaz-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/diaz/files/Diaz/diaz-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Diaz
...
New/changed settings (command-line or diaz.conf file)
--------------------------------------------------------
