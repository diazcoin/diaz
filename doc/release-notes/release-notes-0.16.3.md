Diaz Core version 0.16.3 is now available from:

  <https://diazcore.org/bin/diaz-core-0.16.3/>
...
been discovered in Diaz Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` diazconsensus: invalid flags error should be set to `diazconsensus_err` (afk11)
