Diaz Core version 0.13.2 is now available from:

  <https://diaz.org/bin/diaz-core-0.13.2/>
...
- #8908 `4a974b2` Update diaz-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow diaz-tx to create v2 transactions (diazdrak)
