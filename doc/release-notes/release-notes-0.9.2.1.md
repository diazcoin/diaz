Diaz Core version 0.9.2.1 is now available from:

  https://diaz.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DIAZ to 0.01 DIAZ
...
- Fix "Start diaz on system login"
