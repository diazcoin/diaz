...
This document provides guidelines for internationalization of the Diaz Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `diaz_en.ts` remains unchanged.
