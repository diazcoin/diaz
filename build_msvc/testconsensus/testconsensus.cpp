...
// bitcoin includes.
#include <..\src\script\diazconsensus.h>
...
int main()
{
    std::cout << "diazconsensus version: " << diazconsensus_version() << std::endl;
    ...
    auto op0Result = diazconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, diazconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
